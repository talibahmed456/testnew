<?php
    ...
    try{
        ...
        if(!$korpa){
            ...
            <h3>Cart is empty</h3>
            <a class='button button-header' href='index.php?pages=shop'>Buy Now</a>
            </div>";
        }else{
                    ...
                    if($korpa[$i]["id"]==$result[$j]->product_id){
                        if($i==0){
                            ...
                            <div class='col-sm-6 col-md-4 col-lg-2 centar'>
                                <img class='malaSlikaKorpa' src='assets/".$result[$j]->src."' alt='".$result[$j]->alt."'/></br>
                            </div>
                            <div class='col-sm-6 col-md-4 col-lg-2 centar'>
                                <h5><a href='index.php?pages=single-product&id=".$result[$j]->product_id."'>".$result[$j]->product_name."</a></h5>
                            </div>
                            <div class='col-sm-6 col-md-4 col-lg-2 centar'>
                                <span>Quantity: </span>
                                <button class='btn-plus' type='button' value='".$korpa[$i]["id"].",".$korpa[$i]["size"].",".$korpa[$i]["qty"]."' name='btnQty' onclick='dodajQty(this)'><img src='assets/img/plus.svg' alt='Plus svg'/></button>
                                <input class='kolicinaKorpa' type='number' value='".$korpa[$i]["qty"]."' max='99' min='0' >
                                <button class='btn-minus' type='button' value='".$korpa[$i]["id"].",".$korpa[$i]["size"].",".$korpa[$i]["qty"]."' name='btnQty' onclick='smanjiQty(this)'><img src='assets/img/minus.svg' alt='Minus svg'/></button>
                            </div>
            ...
            <div class='col-sm-6 col-md-4 col-lg-2'></div>
            <div class='col-sm-6 col-md-4 col-lg-2'></div>
            <div class='col-sm-6 col-md-4 col-lg-2 centar'><a href='index.php?pages=checkout' class='button primary-btn'>Checkout</a></div>
